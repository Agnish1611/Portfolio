...
export const metadata: Metadata = {
  ...
  description: "Looking for a Full-Stack Software Engineer? I am Agnish Bhattacharya, a developer from India specializing in Next.js, full-stack tools, and Web3 blockchain apps.",
